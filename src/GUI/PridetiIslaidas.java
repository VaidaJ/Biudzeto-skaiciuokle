...
public class PridetiIslaidas extends javax.swing.JFrame {
    Islaidos islaidos;
    double suma;
    String kategorija;
    Date data;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Įveskite informaciją apie išlaidas");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(prideti == true){
            islaidos.insertIslaidos(suma, kategorija, sqlDate.toString(), komentaras);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PridetiIslaidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PridetiIslaidas().setVisible(true);
            }
        });
    }
